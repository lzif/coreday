  ...
  <main class="flex-1 h-full overflow-y-auto overflow-x-hidden p-4 md:p-8 pb-24 md:pb-8 relative">
    <div class="max-w-7xl mx-auto h-full">
      ...
      <header class="mb-8 flex justify-between items-center">
        <div>
          <h2 class="text-3xl font-bold text-apple-dark capitalize tracking-tight">
            {activeTab}
          </h2>
          <p class="text-gray-500 mt-1">Welcome back to your personal space.</p>
        </div>
        <div class="flex items-center gap-4">
          <div class="w-10 h-10 rounded-full bg-gray-200 border border-white shadow-sm overflow-hidden">
             <!-- Placeholder Avatar -->
